...
`\\?\C:\dev\JobLooper\app\api\database\[model]\create\route.js`:
...
`\\?\C:\dev\JobLooper\app\api\database\[model]\read\route.js`:
...
`\\?\C:\dev\JobLooper\app\components\exampleHeader.js`:
...
`\\?\C:\dev\JobLooper\app\components\ui\exampleButton.js`:
...
`\\?\C:\dev\JobLooper\lib\db\database.js`:
...
`\\?\C:\dev\JobLooper\lib\db\prisma.js`:
...
`\\?\C:\dev\JobLooper\lib\hooks\useDebounce.js`:
...
`\\?\C:\dev\JobLooper\package-lock.json`:
...
`\\?\C:\dev\JobLooper\prisma\schema.prisma`:
...
`\\?\C:\dev\JobLooper\styles\globals.css`:

```````css
@import "./reset.css"; /* IMPORT AV CSS RESET */

```````

`\\?\C:\dev\JobLooper\styles\reset.css`:
